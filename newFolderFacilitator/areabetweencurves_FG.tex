...
\title{Area Between Curves Activity Facilitator Guide}
...
Students should be able to:
    \begin{itemize}
        \item Formulate an integral for the area between two given curves.
        \item Visualize and identify areas represented by definite integrals.
        \item Calculate the area between curves.
        \item Identify bounds on tractable examples of hand-computable areas.
    \end{itemize}

\textbf{Prerequisite Knowledge:} Students will need to understand and visualize areas represented by definite integrals, and know what geometric area is.  Having some idea of what types of functions look like (affine/linear, quadratic especially) will also be helpful.\\

The idea of this activity is for students to be able to build the idea of area between curves for themselves, in the hopes that taking the time to investigate the ``why'' will help students retain the ideas better than just memorizing a formula.
...
\end{align}
    ...
    \end{enumerate}
    \textcolor{blue}{Note that this is a very conceptual version of this problem.  Students often struggle to work with arbitrary functions and variables instead of given equations and numbers. The idea is for students to build for themselves the fact that we need to break up positive and negative areas to get geometric areas.  This doesn't come into effect as often with single functions, but this same idea will come into play with area between curves.}
...
\begin{exercise}
    ...
    \begin{enumerate}
        ...
        \textcolor{orange}{This is a good place for groups who finish early to swap examples with others and check their work together.}
        ...
        \begin{enumerate}
            ...
            \textcolor{orange}{The big idea here is for students to build the ``top-bottom'' idea for themselves.  Often students (and textbooks) do try to formulate the area between curves as an absolute value, but in practice, absolute values are not simpler to work with in integrals and eventually lead to more issues than successes. }
        \end{enumerate}
    \end{enumerate}
...
With your groups discuss both of the following questions:
        \begin{enumerate}
            ...
            \textcolor{orange}{This is more of a challenge problem to get students thinking about the limitations of hand compuations.  I would suggest this problem be left for last, and cut if there is not enough time. }
        \end{enumerate}
\end{exercise}
