...
\title{Volumes Facilitator Guide}
...
Students should be able to:
    \begin{itemize}
        \item Find the area of a geometric solid using integration of cross sectional area.
    \end{itemize}

\textbf{Prerequisite Knowledge:} Students will need to know the geometry of a right circular cone and the equation of its cross section in the plane (equation of a circle).  (Hints are given in the exercise for how to make the calculuations tractable.)  Students will also need to know that for a solid with cross section $A(h)$ and height $h$, $v(t)=\int_0^h A(h)dh$ calculates volume.\\

This single activity may be appended to another activity. 
