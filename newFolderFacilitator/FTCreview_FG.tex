...
\textcolor{orange}{
$\displaystyle\sum_{j=1}^n(a_j+b_j)=\sum_{j=1}^n a_j+\sum_{j=1}^n b_j$\\

$\displaystyle \sum_{j=1}^n ca_j=c\sum_{j=1}^n a_j$, $c$ is any constant\\

$\displaystyle \sum_{j=1}^n c=cn$, $c$ is any constant and $n\geq 1$\\
$\displaystyle \sum_{j=1}^n j=\frac{n(n+1)}{2}$\\

$\displaystyle \sum_{j=1}^n j^2 =\frac{n(n+1)(2n+1)}{6}$\\

Power rule for integration: $\displaystyle\int x^ndx=\frac{x^{n+1}}{n+1}+c$, when $n\neq -1$\\
