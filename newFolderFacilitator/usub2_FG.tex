...
This is meant to be a more ``advanced'' $u$-sub activity, to follow an introductory activity.  %This activity may be on the shorter side, depending on how comfortable students are with $u$-sub at this point.  This activity can be paired with some basic area between curves introduction.
